...
public class LengthTest {
    ...
    public void testWhenLengthIsNegative() throws Exception {
        Length length = new Length(-1, Unit.Length.METER);
    }
...
// ----------------------------------- Test cases for Meter conversion ----------------------------------------
    ...
    public void shouldConvertMeterToMillimeter() {
        Length length = new Length(1, Unit.Length.METER);
        assertEquals(length, length.convertTo(Unit.Length.MILLIMETER));
    }

    @Test
    public void shouldConvertMeterToCentimeter() {
        Length length = new Length(1, Unit.Length.METER);
        assertEquals(length, length.convertTo(Unit.Length.CENTIMETER));
    }

    @Test
    public void shouldConvertMeterToKilometer() {
        Length length = new Length(1, Unit.Length.METER);
        assertEquals(length, length.convertTo(Unit.Length.KILOMETER));
    }

    @Test
    public void shouldConvertMeterToInches() {
        Length length = new Length(1, Unit.Length.METER);
        assertEquals(length, length.convertTo(Unit.Length.INCHES));
    }

    @Test
    public void shouldConvertMeterToFeet() {
        Length length = new Length(1, Unit.Length.METER);
        assertEquals(length, length.convertTo(Unit.Length.FEET));
    }

    @Test
    public void shouldConvertMeterToYards() {
        Length length = new Length(1, Unit.Length.METER);
        assertEquals(length, length.convertTo(Unit.Length.YARDS));
    }

    @Test
    public void shouldConvertMeterToMiles() {
        Length length = new Length(1, Unit.Length.METER);
        assertEquals(length, length.convertTo(Unit.Length.Miles));
    }
...
// ----------------------------------- Test cases for Centimeter conversion ----------------------------------------
    ...
    public void shouldConvertCentimeterToMillimeter() {
        Length length = new Length(1, Unit.Length.CENTIMETER);
        assertEquals(length, length.convertTo(Unit.Length.MILLIMETER));
    }

    @Test
    public void shouldConvertCentimeterToMeter() {
        Length length = new Length(100, Unit.Length.CENTIMETER);
        assertEquals(length, length.convertTo(Unit.Length.METER));
    }
...
// ----------------------------------- Test cases for Kilometer conversion ----------------------------------------
    ...
    public void shouldConvertKilometerToMillimeter() {
        Length length = new Length(1, Unit.Length.KILOMETER);
        assertEquals(length, length.convertTo(Unit.Length.MILLIMETER));
    }
...
// ----------------------------------- Test cases for Inches conversion ----------------------------------------
    ...
    public void shouldConvertInchesToMillimeter() {
        Length length = new Length(1, Unit.Length.INCHES);
        assertEquals(length, length.convertTo(Unit.Length.MILLIMETER));
    }
